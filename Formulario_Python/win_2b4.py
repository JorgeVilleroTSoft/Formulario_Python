...
class Window(QDialog):
    def __init__(self):
        ...
        # Button Tax Name
        self.buttonInGridLayout(buttonOption3, 2, 1, layout, 1,2)
        # Button TariffRate
        self.buttonInGridLayout(buttonOption4, 2, 3, layout, 1,1)
        # Button Back
    ...
    def backPage(self):
        ...
        if variables.__stage__ == '2da parte Prorrateos y DUTY Analysis.':
            self.cams = win_2b2a.Window()
            self.cams.show()
            self.close()
        elif variables.__stage__ == '3ra parte LC for Upload and provision Analysis.' and variables.__upload_fire_cx__ == "Sí, cargar los asientos en Fire CX.":
            self.cams = win_2b3d.Window()
            self.cams.show()
            self.close()
        elif variables.__stage__ == '3ra parte LC for Upload and provision Analysis.' and variables.__upload_fire_cx__ == "No, no cargar los asientos en Fire CX.":
    ...
    def buttonInGridLayout(self, text :str, row :int, column :int, gridLayout, heightRow=1, widthColumn=1):
        ...
        elif text == buttonOption4:
            self.button.clicked.connect(self.winTariffRate)
    ...
    def winTariffRate(self):
        # Run Excel and a setted file.
        os.system('start EXCEL.EXE "%s"' % variables.__path_tariff_rate__)
...
# class EditorTariffRate(QMainWindow):
#     def __init__(self, *args, **kwargs):
#         super(EditorTax, self).__init__(*args, **kwargs)
#         self.setWindowTitle("Editar Tax Names")
#         self.setFixedSize(400, 400)
...
#     def showEvent(self,event): 
#         fileTaxName = open ('Tax Name.txt','r')
#         textFileTaxName = fileTaxName.read()
#         fileTaxName.close()
#         self.textEdit.insertPlainText(textFileTaxName)
...
#         self. alertCheck()
#         newTextModif = self.textEdit.toPlainText()
#         fileTaxName = open ('Tax Name.txt','w')
#         fileTaxName.write (newTextModif)
#         fileTaxName.close()
